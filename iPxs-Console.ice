{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "424d789f-de96-4db2-a659-96d68ba433d5",
        ...
        {
          "id": "9d949760-cfe0-4dd0-bbd1-df221514a863",
        ...
        {
          "id": "60b4367d-e413-4bcd-ad23-37c8d4a6e59e",
          "type": "89547cf51e104b5758965834996a6486cfba8bdc",
          "position": {
            "x": 880,
            "y": 56
          },
        ...
        },
        {
          ...
          "type": "basic.code",
          "data": {
            "code": "reg [7:0] counter = 0;\nreg [6:0] incx=0;\nreg [6:0] incy=0;\n\nassign pos_x = incx;\nassign pos_y = incy;\nassign tcursor = counter;\n\nalways @(posedge dyn_clk)\nbegin\n    counter <= counter + 1;\n    if (counter == 8'h50)\n        counter <= 0;\nend\n\n// Usar las teclas I,K,J,L para mover\n// el cursor\nalways @(posedge rcv)\nbegin\n        case (data)\n            8'h6A: incx <= incx - 1;\n            8'h6C: incx <= incx + 1;\n            8'h6B: incy <= incy + 1;\n            8'h69: incy <= incy - 1;\n        endcase\n        if (incx < 0) incx <= 0;\n        if (incy < 0) incy <= 0;\nend",
            "params": [],
            "ports": {
              "in": [
                {
        ...
        {
          "id": "9a0e19dd-da59-462e-8d09-da88efc9d910",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "424d789f-de96-4db2-a659-96d68ba433d5",
        ...
        {
          "source": {
            "block": "9d949760-cfe0-4dd0-bbd1-df221514a863",
        ...
        },
        {
          ...
          "target": {
            "block": "60b4367d-e413-4bcd-ad23-37c8d4a6e59e",
        ...
        },
        {
          ...
          "target": {
            "block": "60b4367d-e413-4bcd-ad23-37c8d4a6e59e",
            "port": "4031fcfa-3149-4c3b-ab99-36aa538684ff"
          },
          "vertices": [
            {
              "x": 800,
        ...
        },
        {
          ...
          "target": {
            "block": "9a0e19dd-da59-462e-8d09-da88efc9d910",
  ...
  "dependencies": {
    ...
    "89547cf51e104b5758965834996a6486cfba8bdc": {
      "package": {
        "name": "PxsCursor",
        "version": "1.0",
